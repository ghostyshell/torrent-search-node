...
app.put('/api/cache/cover-image/favorite/:favoriteId', cacheController.updateFavoriteEntryCoverImage);
app.put('/api/cache/cover-image/torrent-details/:favoriteId/:source', cacheController.updateTorrentDetailsCoverImage);
app.put('/api/cache/cover-image/cached-link/:cachedLinkId', cacheController.updateCachedLinkCoverImage);
